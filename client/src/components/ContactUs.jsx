    ...
    return ( 
        <div className = "contact-container">
            ...
            <motion.div initial = "out" animate = "in" exit = "out"variants = { animationOne } transition = { transition } >
                ...
                <h1 className = "big-text" > Let 's Make it Happen </h1> <img src = "/images/camera 3.png" alt = "camera" width = "300" height = "300"/>
                ...
                {
                    errors.phone ?
                        <span className = "error-text" > { errors.phone.message } </span> :null
                } 
                <div className = "textbox-bg" >
                ...
                <option value = "" > </option> {
                    themesArray.map((themes) => ( <option value = { themes } key = { themes } > { themes } </option>
                    ))
                } 
                </select>   
                </div> 
                ...
                <div className = "social-media" >
                    ...
                    <img src = "/images/pinterest.png" alt = "" height = "100"
                    width = "100"/>
                    </a> </motion.div>                             
                    <motion.div whileHover = {   { scale: 1.1 } } whileTap = {{ scale: 0.9 } } >
                    <a href = "https://www.instagram.com/_maics_/" >
                    <img src = "/images/instagram.png" alt = "" height = "100" width = "100"/>
                    </a> </motion.div> <motion.div whileHover = {{ scale: 1.1 } } whileTap = {{ scale: 0.9 } } >
